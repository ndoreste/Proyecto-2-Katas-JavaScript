...
console.log("🎸 ROCK PLAYLIST - Canciones más de 5 minutos 🎸");
console.log(rockPlaylist);

//

//Método con un bucle forEach:
console.log("\n🎸 ROCK PLAYLIST - Canciones más de 5 minutos 🎸");

songs.forEach((song, index) => {
  if (song.genre === "Rock" && song.duration > 5.0) {
    console.log(`${index + 1}. ${song.title} - ${song.duration} min`);
  }
});
