...
// Esta variable será nuestro contador
let totalDuration = 0;

for (let i = 0; i < albums.length; i++) {
  if (albums[i].genre === "Rock") {
    // Suma la duración actual al total acumulado de los albums de "Rock"
    totalDuration += albums[i].duration;
  }
}

console.log(`Total de duración de álbumes de rock: ${totalDuration} minutos`);
